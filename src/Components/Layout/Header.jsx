    ...
    <>
      <AppBar position="static">
        ...
        >
          ...
          {userData?.profileImage === undefined ? <img src={user} alt="Profile Image" className='profile-header' />:<img src={userData?.profileImage} alt="Profile Image" className='profile-header' />}
          <Typography
            variant="h6"
            sx={{
              flexGrow: 1,
